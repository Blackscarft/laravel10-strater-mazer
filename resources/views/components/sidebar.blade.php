                ...
                <li class="sidebar-item has-sub {{ Request::routeIs('admin.user.*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu {{ Request::routeIs('admin.user.*') ? 'active' : '' }}">
                        <li class="submenu-item {{ Request::routeIs('admin.user.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.user.index') }}" class="submenu-link">Profile</a>
                        </li>
                        <li class="submenu-item  {{ Request::routeIs('admin.user.new') ? 'active' : '' }}">
                            <a href="{{ route('admin.user.new') }}" class="submenu-link">Akun</a>
                        </li>
                    </ul>
                </li>
                {{-- END AKUN --}}
